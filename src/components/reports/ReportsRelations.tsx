...
import { ArrowLeft, ArrowRight, ArrowRightLeft, Building2, RefreshCw } from "lucide-react";
            ...
            <tbody>
              {relations.map((r) => (
                <tr key={r.form_id} className="border-b hover:bg-gray-50">
                  ...
                  <td className="p-3 text-gray-700">{r.emitter_company_name || "—"}</td>
                  ...
                  <td className="p-3 text-gray-700">{r.receiver_company_name || "—"}</td>
                  <td className="p-3">
                    <span
